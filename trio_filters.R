...
Filter.for.tier2 <- function(data, is.comphet = FALSE) {
  ...
  if (dim(data)[1] ==0) { return(data)}
    ...
    R3 = ((temp == "Pathogenic") | (temp == "Likely pathogenic") | (temp == "Likely pathogenic;Pathogenic")) & !is.na(temp)
    ...
    #inclusion rule 4:
    R4 <- (Functional.1 | Functional.2) & (!(eval(parse(text=paste0("data$",normalized.name("ClinGen HaploinsufficiencyDesc (#1)")))) %in% c("No evidence","Little evidence") | is.na(eval(parse(text=paste0("data$",normalized.name("ClinGen HaploinsufficiencyDesc (#1)")))))))
  ...
  if (dim(data)[1] ==0) { return(data)}
    ...
    #inclusion rule 4:
    R4 <- Functional & (!(eval(parse(text=paste0("data$",normalized.name("ClinGen HaploinsufficiencyDesc")))) %in% c("No evidence","Little evidence") | is.na(eval(parse(text=paste0("data$",normalized.name("ClinGen HaploinsufficiencyDesc")))))))
